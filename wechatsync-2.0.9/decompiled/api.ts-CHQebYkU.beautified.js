    ...
    try {
        ...
        if (e.type === "SYNC_PROGRESS") {
            ...
            if (n) {
                ...
                o && (o.status = n.success ? "done" : "failed", o.error = n.error, o.msg = void 0, o.editResp = n.success ? {
        ...
        if (e.type === "SYNC_DETAIL_PROGRESS") {
            const n = e.payload || e,
                o = d.find(u => u.type === n.platform);
            o && (o.status = "uploading", o.msg = n.stage === "uploading_images" ? `上传图片 ${(s=n.imageProgress)==null?void 0:s.current}/${(t=n.imageProgress)==null?void 0:t.total}` : n.stage === "saving" ? "保存中..." : n.stage), h({
                accounts: d
            })
        }
    ...
    try {
        ...
        if (r.method === "getAccounts" && chrome.runtime.sendMessage({
                ...
                if (chrome.runtime.lastError) {
                    m.error("getAccounts error:", chrome.runtime.lastError), i({
                        eventID: r.eventID,
                        result: []
                    });
                    return
...
function f() {
    setTimeout(function() {
        ...
        e.src = chrome.runtime.getURL("inject-api.js"), e.onload = function() {
            e.remove()
